    ...
    <div class="form">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <table class="items generate-item-table" border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12 ">
                <?php echo CHtml::submitButton(Rights::t('core', 'Generate'), array('class' => 'btn btn-info')); ?>
