...
class Rights
{
	...
	*/
	public static function getAuthItemOptions($t)
	{
		return array(
			CAuthItem::TYPE_OPERATION=> $t ? Rights::t('core', 'Operation') : 'Operation',
			CAuthItem::TYPE_TASK=> $t ? Rights::t('core', 'Task') : 'Task',
			CAuthItem::TYPE_ROLE=> $t ? Rights::t('core', 'Role') : 'Role',
		);
	}
	...
	*/
	public static function getAuthItemTypeName($type,$t=true)
	{
		$options = self::getAuthItemOptions($t);
