...
$('#export').click(function(){
    var url = '" . Yii::app()->createUrl('interview/offer/export') . "' + window.location.search;
    location.href = url;
    return false;
});
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <?php echo $form->label($model, 'entryDate', array('class' => 'col-sm-3 control-label no-padding-right')); ?>
            <div class="col-sm-9">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
                    <?php echo $form->textField($model, 'entryDate', array('class' => 'col-sm-12 col-xs-12 range-picker', 'autocomplete' => 'off', 'readonly' => true)); ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <?php $this->widget('CAutoComplete', array(
                    'model'=>$model,
                    'attribute'=>'channel',
                    'url'=>array('/interview/feedback/suggestChannel'),
                    'multiple'=>true,
                    'multipleSeparator'=>' ',
...
<div class="row search-more" style="display: none">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <?php echo $form->textField($model, 'phone', array('class' => 'col-sm-12 col-xs-12 col-xs-12')); ?>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-12 col-xs-12">
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <?php echo $form->label($model, 'isEntry', array('class' => 'col-sm-3 control-label no-padding-right')); ?>
                    <div class="col-sm-9">
                        <?php echo $form->dropDownList($model, 'isEntry', $model->_if, array('class' => 'col-sm-12 col-xs-12', 'prompt' => '请选择')); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <?php echo $form->label($model, 'departureDate', array('class' => 'col-sm-3 control-label no-padding-right')); ?>
                    <div class="col-sm-9">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
                            <?php echo $form->textField($model, 'departureDate', array('class' => 'col-sm-12 col-xs-12 range-picker', 'autocomplete' => 'off', 'readonly' => true)); ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-12 col-xs-12">
        <div class="clearfix form-actions">
            <div class="col-md-offset-3 col-md-9">
                ...
                <?php if (Yii::app()->user->checkAccess("Interview.Offer.Export")): ?>
